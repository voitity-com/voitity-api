...
class VideoAIImageTest extends TestCase
{
    ...
    {
        $image = new VideoAIImage(status: 'SUCCEEDED', output: ['https://example.com/image.png']);
    ...
    {
        $failed = new VideoAIImage(status: 'error');
        $pending = new VideoAIImage(status: 'PENDING');
