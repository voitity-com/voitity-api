...
class ProfileSourceResponse
{
    ...
    public function toArray(): array
    {
        return [
            ...
            'processing_stage' => $this->source->processing_stage,
            'last_error' => $this->source->last_error,
            'retry_count' => $this->source->retry_count,
            'retryable' => $this->source->status?->value === 'failed' && filled($this->source->extracted_text),
            'processing_started_at' => $this->source->processing_started_at?->toJSON(),
            'processing_completed_at' => $this->source->processing_completed_at?->toJSON(),
