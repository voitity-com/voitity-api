...
class BusinessVisitorConfirmation extends Mailable
{
    ...
    public function envelope(): Envelope
    {
        ...
        return new Envelope(
            ...
            subject: 'Recibimos tu información - '.$this->lead->business->name,
        );
    }

    public function content(): Content
    {
        return new Content(view: 'emails.business-visitor-confirmation');
    }
}
