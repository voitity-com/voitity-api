...
Este directorio contiene pruebas reproducibles y evidencias. Está separado de `src/` para que los fixtures, capturas y guías de QA no se mezclen con el código de la aplicación.
...
- [`avatar-variants/AVATAR_VARIANTS_QA.md`](avatar-variants/AVATAR_VARIANTS_QA.md): original, imagen mejorada, animación, fallos parciales y activación por versión.
